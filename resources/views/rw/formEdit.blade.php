@foreach ($data as $d)
    <div class="modal fade" id="editData{{ $d->id }}" tabindex="-1" aria-labelledby="editRWLabel{{ $d->id }}"
        aria-hidden="true">
                ...
                <form action="{{ url('rw/update/' . $d->id) }}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control text-capitalize" value="{{ $d->nama }}" name="nama"
                                required>
                        </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" value="{{ $d->rw }}" name="rw" id="rw{{ $d->id }}"
